...
$('.photo-toggle-link').click(function(){
    ...
    clickPhoto++;
    if(clickPhoto% 2 === 0){
        $('#the-body').css({"transform": "scale(1)", "transform-origin": "70% 65%"});
        ...
        $('#the-body').css({"transform": "scale(5)", "transform-origin": "15% 60%"});
...
$('#designs-link').click(function(){
    ...
    $('#the-body').css({"transform": "scale(5)", "transform-origin": "56.5% 92%"});
...
$('#design-power-off').click(function(){
    $('#the-body').css({"transform": "scale(1)", "transform-origin": "56.5% 92%", "width": "100%"});
