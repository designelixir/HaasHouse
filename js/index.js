...
$('.film-toggle').click(function(){
    ...
    if(clickFilm % 2 === 0){
        ...
        $('#the-body').css({"transform": "scale(5)", "transform-origin": "59% 36%"});
...
$('#designs-link').click(function(){
    ...
    $('#the-body').css({"transform": "scale(5)", "transform-origin": "56.5% 88%"});
...
$('#design-power-off').click(function(){
    $('#the-body').css({"transform": "scale(1)", "transform-origin": "56.5% 88%"});
